...
questions=(
"How many branches does mulu jewellry have?" ,
"what is the difference between natural and laboratory gemstones?",
"What are america diamonds?",
"What are the gemstones of each month?",
"What is the store policy?",
"What are the repair prices?",
"What is the summary of the whole document?",

)

for question in questions:
    print(f"Question: {question} ")
    print(f"Answer: {chain.invoke({"context": context, "Question": question})}")
